namespace GameData
{
    ...
    public enum AbilityEffect { NONE, HEAL, STATMOD, STANCECHANGE, APPLYSTATUS, CURESTATUS, HEALATTACK, RAISEDCRITCHANCE, FLINCH, CANTMISS, VARIABLEPOWER, LEECH, RECOIL, INMOLATE, SETEVASIVE, PROVOKE }
    public enum AbilityType { ACTIVE, PASSIVE }
    public enum AbilityPowerVariables { REMAININGHP, DUPEONALLYDOWNED}
    ...
    public enum Stats { HP, ATK, DEF, SPEED, LUCK, PRECISION }
