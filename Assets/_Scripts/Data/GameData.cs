namespace GameData
{
    ...
    public enum AbilityEffect { NONE, HEAL, UPATK, UPDEF, UPSPEED, DOWNATK, DOWNDEF, DOWNSPEED, STANCECHANGE, APPLYSTATUS, CURESTATUS, HEALATTACK, RAISEDCRITCHANCE, FLINCH }
