namespace GameData
{
    ...
    public enum AbilityEffect { NONE, HEAL, STATMOD, STANCECHANGE, APPLYSTATUS, CURESTATUS, HEALATTACK, RAISEDCRITCHANCE, FLINCH, CANTMISS, VARIABLEPOWER, LEECH, RECOIL }
