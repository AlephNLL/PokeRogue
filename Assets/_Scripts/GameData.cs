namespace GameData
{
    ...
    public enum PassiveEffects { UPATK, UPATKIFBURN, UPDEF, UPSPEED, DOWNATK, DOWNDEF, DOWNSPEED, ADDTURN, SKIPTURN, APPLYBURN, APPLYPARA, APPLYPOISON, APPLYFRZ, APPLYSLP }
